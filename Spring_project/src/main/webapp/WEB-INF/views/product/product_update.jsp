...
<script type="text/javascript">
	function update(f) {
		...
		var p_state = f.p_state.value.trim();
		
		var url = "product_update.do";
		var param = "p_name="+p_name+"&p_price="+p_price+"&p_text="+p_text+"&p_idx="+p_idx+"&p_state="+p_state;
	...
	<div class="container">
		<form>
			<div class="CSSgal">
				...
				<div class="slider">
					<div
						style="background-image: url('${pageContext.request.contextPath}/resources/upload/${vo.p_img1}');">
						<h2>IMG 1</h2>
					</div>
					<div
						style="background-image: url('${pageContext.request.contextPath}/resources/upload/${vo.p_img2}');">
						<h2>IMG 2</h2>
					</div>
					<div
						style="background-image: url('${pageContext.request.contextPath}/resources/upload/${vo.p_img3}');">
						<h2>IMG 3</h2>
					</div>
				</div>
			...
			<input type="hidden" value="${vo.p_idx}" name="p_idx"> <input
				name="p_price"
				style="padding-top: 10px; font-size: 18px; font-weight: bold; color: black; text-align: left; border: none;"
				value="${vo.p_price}"> <input name="p_text"
				value="${vo.p_text}"
			...
			<div style="position: fixed; top: 90%; left: 67%;">
				<input type="button" value="상품 등록" onclick="update(this.form);"
					class="insert_btn"
