...
<script type="text/javascript">
	function p_search(e) {
		var p_name = document.getElementById("p_search").value;
		
		if(e.keyCode == 13) {
			location.href = "product_search.do?p_name="+p_name;
		}
	}
	...
	function add_heart(m_idx, p_idx) {
		...
		if (heart_img.src.match("resources/img/heart_white.png")) {
			heart_img.src = "resources/img/heart_red.png";
		} else {
			heart_img.src = "resources/img/heart_white.png";
		}

		var m_idx = m_idx;
		var p_idx = p_idx;
		var my_idx = document.getElementById("md_idx").value;
		var m_idx_now = ${id.m_idx};
...
<body>
	...
	<div id="header">
		<nav>
			<ul>
				...
				<li><input class="header_search" type="text" id="p_search"
					placeholder="물품명을 검색해보세요" onkeypress="p_search(event);"></li>
				<li><input class="header_input" type="button" value="쪽지" onclick="location.href='message.do'"></li>
			</ul>
		</nav>
	</div>
	<!-- header -->
							...
							<c:forEach var="vo" items="${list}">
								<figure class="palette">
									...
									<figcaption class="palette_caption">
										<div style="width: 294px; height: 294px; position: relative;" class="jb-wrap">
	...
	<div style="position: fixed; top: 90%; left: 90%;">
		<input type="button" value="상품 등록"
			onclick="location.href='product.do'" class="insert_btn">
	</div>
