...
public class Context_3_dao {
	...
	@Bean
	public IT_ChatDAO chat_dao(SqlSession sqlSession) {
		return new IT_ChatDAO(sqlSession);
	}

	@Bean
	public IT_Chat_MessageDAO message_dao(SqlSession sqlSession) {
		return new IT_Chat_MessageDAO(sqlSession);
	}
