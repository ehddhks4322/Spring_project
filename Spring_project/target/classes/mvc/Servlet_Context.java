...
import com.korea.test_member.ChatController;
...
//	  resolver.setSuffix(".jsp"); return resolver; }
	...
	@Bean
	public MemberController memberController(IT_BoardDAO board_dao, IT_Board_DetailDAO board_detail_dao,
			IT_MemberDAO member_dao, IT_Member_DetailDAO member_detail_dao, IT_ProductDAO product_dao) {
		return new MemberController(board_dao, board_detail_dao, member_dao, member_detail_dao, product_dao);
	}

	@Bean
	public ChatController ChatController(IT_ChatDAO chat_dao, IT_Chat_MessageDAO message_dao, IT_MemberDAO member_dao) {
		return new ChatController(chat_dao, message_dao, member_dao);
	}
